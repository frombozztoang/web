...
const InterestRateGuide: React.FC<TInterestRateGuideProps> = ({
  ...
  return (
    <div className='mt-20 tablet:mt-26 desktop:mt-64'>
      ...
      <hr className='mt-3 w-310 mb-15 border tablet:w-397 tablet:mt-4 tablet:mb-20 desktop:w-766 desktop:mt-10 desktop:mb-39 border-border04 dark:border-dark-typoPrimary' />
      <h1 className='mb-3 paragraph-small tablet:paragraph-medium tablet:mb-3 desktop:mb-10 desktop:heading-large text-typoPrimary dark:text-dark-typoPrimary'>
        예치 금액
      </h1>
      ...
      <div className='w-310 tablet:w-397 rounded-7 mt-15 py-6 tablet:mt-20 tablet:py-8 bg-mainLevel200 desktop:rounded-10 desktop:py-17 desktop:mt-39 desktop:w-775'>
        <div className='flex justify-between'>
          <div className='paragraph-small ml-12 tablet:paragraph-medium tablet:ml-15 desktop:ml-13 desktop:label-medium text-typoPrimary dark:text-dark-typoSecondary'>
            기본 세후 수령액
          </div>
          <div className='mr-10 paragraph-small tablet:mr-15 tablet:paragraph-medium desktop:mr-23 desktop:label-medium text-typoPrimary dark:text-dark-typoSecondary'>
            @@@@원
          </div>
        </div>
