...
const SelectBtn: React.FC<TSelectBtn & React.HTMLAttributes<HTMLButtonElement>> = ({ isOn, ...props }) => {
  return (
    <button
      {...props}
      className={cls('inline-flex justify-center items-center px-10 py-4 bg-secondary border rounded-20', isOn ? 'border-main' : 'border-border01')}
    >
